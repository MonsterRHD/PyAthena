...
Under [cloudformation](https://github.com/pyathena-dev/PyAthena/tree/master/cloudformation) you will also find a CloudFormation template with additional permissions and workgroup settings needed for testing.
